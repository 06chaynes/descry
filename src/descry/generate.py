...
_STDLIB_PREFIXES = (
    ...
    "matplotlib.",
    "tensorflow.",
    # ── Python DB / conn receiver patterns ──
    "cursor.",
    "conn.",
)
...
_LIBRARY_PREFIXES = (
    ...
    "Get.",
    "GetX.",
    # ── jemalloc internals (leak in via redis/*.c, postgres extensions,
    # and other C projects that vendor jemalloc). These are not project
    # symbols and will never resolve via scip-clang alone.
    "mallctl",
    "mallctlbymib",
    "mallctlnametomib",
    "malloc_mutex_",
    ...
    # ── Ruby MRI C API (rb_* functions, RSTRING_PTR, NIL_P, etc.) that
    # appear in gem-shipped C extensions (puma's http11 parser, nokogiri,
    # etc.). Called from .c files; never project symbols.
    "rb_",
    "RARRAY_",
    "RSTRING_",
    "RHASH_",
    ...
    "RB_TYPE_P",
    "BUILTIN_TYPE",
    # ── JRuby Java-side API (getRuntime, callMethod, etc.). These only
    # appear in JRuby extensions and never resolve to project symbols.
    "getRuntime",
    "callMethod",
    "newArray",
    "newInstance",
